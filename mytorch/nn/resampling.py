...
class Upsample1d():
    ...
    def forward(self, A):
        ...
        Z = np.zeros((A.shape[0],A.shape[1],self.upsampling_factor*(A.shape[2]-1)+1),dtype='float64') # TODO
...
class Downsample1d():
    ...
    def forward(self, A):
        ...
        Z = np.zeros((A.shape[0],A.shape[1],int((A.shape[2]-1)/self.downsampling_factor+1)), dtype='float64') # TODO 
    ...
    def backward(self, dLdZ):
        ...
        dLdA = np.zeros((self.req_shap[0],self.req_shap[1],self.req_shap[2]),dtype='float64') # TODO
...
class Upsample2d():
    ...
    def forward(self, A):
        ...
        """
        self.A=A
        Z = np.zeros((A.shape[0],A.shape[1],self.upsampling_factor*(A.shape[2]-1)+1,self.upsampling_factor*(A.shape[3]-1)+1),dtype='float64') # TODO
...
class Downsample2d():
    ...
    def forward(self, A):
        ...
        Z = np.zeros((A.shape[0],A.shape[1],int((A.shape[2]-1)/self.downsampling_factor+1),int((A.shape[3]-1)/self.downsampling_factor+1)), dtype='float64')  # TODO
    ...
    def backward(self, dLdZ):
        ...
        dLdA = np.zeros((self.req_dim[0],self.req_dim[1],self.req_dim[2],self.req_dim[3]),dtype='float64')  # TODO
